...
def main(args):
    ...
    if args.optimizer == 'SGD':
        ...
        beta1_sch = CustomScheduler(optimizer, param_name="beta1", decay_epochs=50, decay=0.1)
        beta2_sch = CustomScheduler(optimizer, param_name="beta2", decay_epochs=50, decay=0.1)
        thres_sch = CustomScheduler(optimizer, param_name="threshold", decay_epochs=50, decay=0.1)
    else:
